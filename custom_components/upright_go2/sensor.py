...
SENSORS: tuple[UprightGo2SensorDescription, ...] = (
    ...
    UprightGo2SensorDescription(
        key="slouching_yesterday",
        translation_key="slouching_yesterday",
        device_class=SensorDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.SECONDS,
        suggested_unit_of_measurement=UnitOfTime.MINUTES,
        suggested_display_precision=0,
        value_fn=lambda data: data.slouching_yesterday,
    ),
    UprightGo2SensorDescription(
        key="upright_yesterday",
        translation_key="upright_yesterday",
        device_class=SensorDeviceClass.DURATION,
        native_unit_of_measurement=UnitOfTime.SECONDS,
        suggested_unit_of_measurement=UnitOfTime.MINUTES,
        suggested_display_precision=0,
        value_fn=lambda data: data.upright_yesterday,
    ),
    UprightGo2SensorDescription(
        key="history_days",
